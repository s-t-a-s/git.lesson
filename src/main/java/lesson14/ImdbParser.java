...
public class ImdbParser {
    ...
    //метод getRequest принимает на вход URL страницы и возвращает ее содержимое
    ...
    //создаем коллекцию (список) для URL фильмов
    public List<String> movieUrls = new ArrayList<>();


    //создаем коллекцию (список) для фильмов
